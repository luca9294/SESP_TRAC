...
import org.jsonrpc.JSONRPCParams.Versions;
...
public abstract class JSONRPCClient {
	...
	protected JSONObject doRequest(String method, Object[] params)
		...
		for (final Object param : params) {
			if (param.getClass().isArray()) {
				JSONArray ar = getJSONArray((Object[]) param);
	...
	protected JSONObject doRequest(String method, JSONArray params)
			throws JSONRPCException, JSONException {
	...
	public String callString(String method, JSONArray params)
			throws JSONRPCException {
		try {
			return doRequest(method, params).getString("result");
		} catch (final JSONException e) {
	...
	public Object callInt(String method, JSONArray params)
			throws JSONRPCException {
		JSONObject response = null;
		try {
			response = doRequest(method, params);
	...
	public long callLong(String method, JSONArray params)
			throws JSONRPCException {
		JSONObject response = null;
		try {
			response = doRequest(method, params);
	...
	public boolean callBoolean(String method, JSONArray params)
			throws JSONRPCException {
		JSONObject response = null;
		try {
			response = doRequest(method, params);
	...
	public double callDouble(String method, JSONArray params)
			throws JSONRPCException {
		JSONObject response = null;
		try {
			response = doRequest(method, params);
	...
	public JSONObject callJSONObject(String method, JSONArray params)
			throws JSONRPCException {
		JSONObject response = null;
		try {
			response = doRequest(method, params);
			...
			if (_debug) {
				Log.i(this.getClass().getName(), "callJSONObject response"
						+ response.toString());
				Log.i(this.getClass().getName(),
						"callJSONObject response.JSONObject(result)"
			...
			try {
				Log.i(this.getClass().getName(),
						"callJSONObject response.String(result)"
	...
	public JSONArray callJSONArray(String method, JSONArray params)
			throws JSONRPCException {
		JSONObject response = null;
		try {
			response = doRequest(method, params);
